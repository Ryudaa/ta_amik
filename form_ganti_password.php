...
<html lang="id">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="needs-validation" novalidate action="proses_ganti_password.php" method="POST">
                <input hidden name="username" <?php echo "value='$username'"; ?> />
                <div class="form-group">
                    <label for="password_lama">Password lama</label>
                    <input maxlength="50" type="password"  class="form-control" name="password_lama" id="password_lama" placeholder="Password Lama"
                    required>
